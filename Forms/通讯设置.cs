...
namespace WY_App
{
    public partial class 通讯设置 : Form
    {
        ...
        private void ParamSettings_Load(object sender, EventArgs e)
        {
			...
			check_ImagePath2.Checked = Parameters.commministion.UploadTwoEnable;
			check_ImagePath3.Checked = Parameters.commministion.UploadThreeEnable;

			check_ImageTestPath1.Checked = Parameters.commministion.UploadOneTestEnable;
			check_ImageTestPath2.Checked = Parameters.commministion.UploadTwoTestEnable;
			check_ImageTestPath3.Checked = Parameters.commministion.UploadThreeTestEnable;
		...
		private void chk_PLCEnabled_CheckedChanged(object sender, EventArgs e)
		{

		}

		private void check_ImagePath1_CheckedChanged(object sender, EventArgs e)
		{
