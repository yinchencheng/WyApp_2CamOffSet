...
namespace WY_App
{
    public partial class MainForm : Form
    {
		...
		public static HObject[] hoRegions = new HObject[8];
        bool m_Pause = false;
		...
		public static void PlcSheetNum()   //读取片材编号
		{
           ...
           // {
			...
			{
				productSheetNums = SubStrFile.Substring(0, FileOutLong);
		...
		{
			string pathOut = Parameters.commministion.ImageSavePath + strDateTimeDay + "\\" + Product;
        ...
        private void btn_Start_Click(object sender, EventArgs e)
        {
            ...
            if (Halcon.CamConnect[0] && Halcon.CamConnect[1])
            {
